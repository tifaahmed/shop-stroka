<div class="product-card product-card--hidden-actions @if( isset($horizontal) && $horizontal ) product-card--layout--horizontal @endif" >
    ...
    <div class="product-card__image product-image">
        <a href="product_details.php" class="product-image__body">
            <img class="product-image__img " src="{{asset($products_val->image_one)}}" title="{{$products_val->image_one_alt}}" alt="{{$products_val->image_one_alt}}">        </a>
    </div>
    <div class="product-card__info">
        <div class="product-card__name">
            <a href="product_details.php">{{$products_val->home_title}}</a>
        </div>
