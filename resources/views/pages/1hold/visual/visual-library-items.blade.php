...
@section('title')
<title>نشاطات اجتماعية   </title>
@endsection

@section('meta')
    <meta name="description" content="عناصر  نشاطات اجتماعية  ">
    <meta name="keywords" content="نشاطات اجتماعية  ">

         <meta property="og:title"  content="نشاطات اجتماعية  "/>
         <meta property="title"  content="نشاطات اجتماعية  "/>


    <meta property="og:description" content="عناصر  نشاطات اجتماعية  "/>
@endsection
...
<div class="pageContent">
	...
	<div class="breadcrumbs">
	    <div class="container">
	         <a href="{{asset('/')}}">الرئيسية</a><i class="fa fa-long-arrow-left"></i><span>   نشاطات اجتماعية  </span>
	    </div>
	</div>
	...
	<div>
		<div class="container-fluid">
			<div class="row row-eq-height">
				...
				@include('pages.partials.side1', ['items_one' => $visual_library_latest ,'items_two' => $Visual_library_random , 'name' => 'النشاطات اجتماعية  ' , 'url'=>'نشاطات-اجتماعية'])
		                                 	...
		                                 	<div class="post-item">
			                                    <article class="post-content">
			                                        ...
			                                        <div class="post-item-rit">
			                                            ...
			                                            <p>{{ str_limit($val->home_subject_ar, 150) }} <a class="more_btn main-color" href="{{asset('/نشاطات-اجتماعية/'.$val->url_ar)}}">... اقرا المزيد</a></p>
			                                        </div>
			                                    </article>
			                                </div>
		                                </div>
