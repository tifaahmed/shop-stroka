...
@section('title')
<title>{{ $victim_category->page_title_ar}}</title>
@endsection

@section('meta')
    <meta name="description" content="{{$victim_category->description_ar}}">
    <meta name="keywords" content="{{$victim_category->keywords_ar}}">

         <meta property="og:title"  content="{{$victim_category->home_title_ar}}"/>
         <meta property="title"  content="{{$victim_category->home_title_ar}}"/>


    <meta property="og:description" content="{{$victim_category->description_ar}}"/>
    <meta property="og:url"       content="{{asset('/vectems/'.$victim_category->url_ar)}}"/>
...
<div class="pageContent">
    ...
    <div class="breadcrumbs">
        <div class="container">
            ...
            <i class="fa fa-long-arrow-left main-color"></i><a href="#"> من نحن   </a>
            <i class="fa fa-long-arrow-left main-color"></i><span>{{$victim_category->home_title_ar}}</span>
        </div>
    </div>
			    ...
			    <div class="container-fluid">
			        <div class="row row-eq-height">
			            <div class="col-md-12 md-padding">
			                ...
			                <div class="aseer blog-posts news grid">
			                    <div class="row">
			                    	@foreach($victim_order as $val)
			                    	<?php 
			                    	    $months = array("Jan" => "يناير", "Feb" => "فبراير", "Mar" => "مارس", "Apr" => "أبريل", "May" => "مايو", "Jun" => "يونيو", "Jul" => "يوليو", "Aug" => "أغسطس", "Sep" => "سبتمبر", "Oct" => "أكتوبر", "Nov" => "نوفمبر", "Dec" => "ديسمبر");
			                    	    $your_date = $val->created_at->format('y-m-d'); // The Current Date
			                    	    $en_month = $val->created_at->format("M", strtotime($your_date)) ;
			                    	    ...
			                    	    // $d_date = str_replace($standard , $eastern_arabic_symbols , $d_date);
			                    	?>
			                    	<div class="col-md-6" style="height: 360px !important ; max-height: 360px !important ;min-height: 360px !important; " >	
			                    		<div class="post-item" style="height: 360px !important ; max-height: 360px !important ;min-height: 360px !important; ">
					                        <article class="post-content">
					                            <div class="post-image main-border bot-4-border">
					                            	<a href="{{asset('/single-victim/'.$val->url_ar)}}">
					                                	<img src="{{asset($val->image)}}" alt="{{$val->image_alt_ar}}">	
					                                </a>
					                            </div>
			                ...
			                @include('pages.default', ['paginator' => $victim_order])
