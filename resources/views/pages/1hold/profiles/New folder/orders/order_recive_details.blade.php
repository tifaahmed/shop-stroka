 ...
 @section('profile_content')
  ...
  <section class="shop-contents">
    <div class="section-padding">
      <div class="container">
        <div class="row">
          <h2 style="text-align: center;">تفاصيل  الطلب الوارد</h2>
          ...
          <div class="col-md-4">
            ...
            <div class="text-center">
              <?php                   
               $profile_info = App\Models\Profile_info::where('user_id', $clint_user->id)->first();
              ?>
                <img src="{{asset($clint_user->avatar)}}" style="width: 150px;height: 150px;border-radius: 50%;">
            ...
            <li class="list-group-item">
             ...
             <a href="{{asset('recive_orders_details_print/'.$orders->id)}}" class="btn" style="margin-bottom: 20px;">طباعة</a>
