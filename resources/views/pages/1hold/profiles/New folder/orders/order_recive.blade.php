...
@section('profile_content')
 ...
 <section class="list-panels text-center">
    <div class="lists list-profile">
      <br>
            <h2 style="text-align: center;">الطلبات   الواردة</h2>
              ...
              <div class="col-sm-12">
                <ul class="list-group">
                  ...
                  <li class="list-group-item">
                    <div class="row">
                      <div class="col-sm-2">
                        <a href="{{asset('recive_orders_details/'.$valuse->id)}}">
                          <img src="{{asset($first_product_items->image_one)}}" alt="talb" style="width:150px;">
                        </a>
                      </div>
                      <div class="col-sm-10">
                        <div style="margin-bottom: 30px;">
                          <a href="{{asset('recive_orders_details/'.$valuse->id)}}" style="color:#ee7b2a;font-size: 20px">اسم الطلب  : {{$valuse->full_name}}
                          </a>
                        </div>
