...
@section('title')
<title>{{ $galary_details->page_title_ar}}</title>
@endsection
@section('meta')
<meta name="description" content="{{$galary_details->description}}">
<meta name="keywords" content="{{$galary_details->keywords}}">

     <meta property="og:title"  content="{{$galary_details->page_title_ar}}"/>
     <meta property="title"  content="{{$galary_details->page_title_ar}}"/>

<meta property="og:description" content="{{$galary_details->description}}"/>
<meta property="og:url"       content="{{asset('/projects/'.$galary_details->url_ar)}}"/>
@endsection
                                    ...
                                    <li>
                                        <div class="post-img">
                                            <a href="{{asset('/projects-collection/'.$val->url_ar)}}">
                                                <img height="65" width="100%" src="{{asset($val->image_one)}}" alt="{{$val->image_alt_ar}}">
                                            </a>
                                        </div>
                    ...
                    <div class="row row-eq-height">
                        <div class="col-md-12">
                            <div class="blog-posts news grid gall">
                                <div class="row">
                                    @foreach($galary_categories as $val)
                                    <?php
                                            ...
                                            <article class="post-content">
                                                <div class="post-image main-border bot-4-border">
                                                    ...
                                                    <a  href="gallery-details.php">
                                                        <div class="row s-row">
                                                            @if( !$val->image_title_ar_two && !$val->image_three && !$val->image_four)
                                                            <div class=" ">
                                                               <img height="200px" src="{{asset($val->image_one)}}" alt="{{$val->image_title_ar_one}}"> 
                                                            </div>
                                                            @else
                                                            <div class="col-sm-6 s-img">
                                                               <img src="{{asset($val->image_one)}}" alt="{{$val->image_title_ar_one}}"> 
                                                            </div>
                                                            <div class="col-sm-6 s-img">
                                                               <img src="{{asset($val->image_two)}}" alt="{{$val->image_title_ar_two}}"> 
                                                            </div>
                                                            <div class="col-sm-6 s-img">
                                                               <img src="{{asset($val->image_three)}}" alt="{{$val->image_title_ar_three}}"> 
                                                            </div>
                                                            <div class="col-sm-6 s-img">
                                                               <img src="{{asset($val->image_four)}}" alt="{{$val->image_title_ar_four}}"> 
                                                            </div>
                                                            @endif                                                    
                                                        </div>
...
<!--                                                         <div class="row s-row">
                                                            <div class="col-xs-6 ">
                                                               <img style="width: 220px; height: 100px" src="{{asset($val->image_one)}}" alt="{{$val->image_title_ar_one}}"> 
                                                            </div>
                                                            <div class="col-xs-6  ">
                                                               <img style="width: 220px; height: 100px" src="{{asset($val->image_two)}}" alt="{{$val->image_title_ar_two}}"> 
                                                            </div>
                                                            <div class="col-xs-6 ">
                                                               <img  style="width: 220px; height: 100px" src="{{asset($val->image_three)}}" alt="{{$val->image_title_ar_three}}"> 
                                                            </div>
                                                            <div class="col-xs-6 " style=" ">
                                                               <img  style="width: 300px !important; height: 100px" src="{{asset($val->image_four)}}" alt="{{$val->image_title_ar_four}}"> 
                                                            </div>
                                                ...
                                                <div class="post-item-rit">
                                                    <div class="post-info-container">
                                                        <div class="post-info">
                                                        <h5><a href="{{asset('/projects-collection/'.$val->url_ar)}}"> {{ str_limit($val->title_ar, 250) }}</a></h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </article>
                            ...
                            @include('pages.default', ['paginator' => $galary_categories])
