...
<div id="app">
	<form id="reset_password_form" method="post" action="{{ asset($action) }}" enctype="multipart/form-data" >  {{ csrf_field() }}        
    <input  name="remember_token" type="password" value="{{$id}}" hidden style="display: none;">
		...
		<div class="row text-center">
          ...
          <div class="form-group">
            ...
            <input id="password" class="form-control" placeholder="**************" name="password" type="password" required>
          </div>
					<div class="form-group">
            <label for="">  تاكيد  كلمة المرور    </label>
            <input class="form-control" placeholder="**************" name="password_check" type="password" required>
          </div>
   ...
   rules: {
	   	email: {
	   	      ...
	   	      "remote": {
	   	          ...
	   	          data: {
	   	              email: function() {
	   	                  return $('#reset_password_form :input[name="email"]').val();
	   	              }
	   	          }
	   	      }
	   	  },   
