...
"accepted" => "يجب قبول :attribute.",
    ...
    "between.string" =>
        "يجب أن يكون عدد حروف نّص حقل :attribute بين :min و :max.",
    ...
    "password.numbers" =>
        "يجب أن يحتوي حقل :attribute على رقمٍ واحدٍ على الأقل.",
    "password.symbols" =>
        "يجب أن يحتوي حقل :attribute على رمزٍ واحدٍ على الأقل.",
