...
// Resource
use App\Http\Resources\Dashboard\Collections\CityCollection as ModelCollection;
use App\Http\Resources\Dashboard\City\CityResource as ModelResource;
// lInterfaces
use App\Repository\CityRepositoryInterface as ModelInterface;

// Requests
use App\Http\Requests\Api\Dashboard\City\CityStoreApiRequest as modelInsertRequest;
use App\Http\Requests\Api\Dashboard\City\CityUpdateApiRequest as modelUpdateRequest;
...
class CityController extends Controller
{
    ...
    public function __construct(ModelInterface $Repository)
    {
        ...
        $this->folder_name = 'city/'.date('Y-m-d-h-i-s');
        $this->file_columns = [];
